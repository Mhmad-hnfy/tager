      ...
      <footer className="bg-slate-900 text-white pt-14 pb-6">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mb-10">
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="tel:0699353554"
                  className="flex items-center gap-3 bg-slate-800 hover:bg-slate-700 transition-colors rounded-xl px-4 py-3 group"
                >
                  ...
                  <div>
                    <p className="text-[11px] text-slate-500">اتصل بنا</p>
                    <p className="text-sm font-bold text-white" dir="ltr">0699 35 35 54</p>
                  </div>
                </a>
                <a
          ...
          <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <p className="text-slate-600 text-xs">من الجملة إلى محلك 🛒</p>
          </div>
        </div>
      </footer>
    </div>
